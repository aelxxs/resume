...
\usepackage[left=0.35in,right=0.35in,bottom=0.35in,top=0.35in]{geometry}
\usepackage{charter}
...
\begin{center}
    {\huge Alexis Vielma} \\
    \vspace{5pt}
    \href{mailto:alexis@alexis.lol}{\underline{alexis@alexis.lol}}
	\hspace{15pt}
    \href{https://alexis.lol/}{\underline{alexis.lol/}}
    \hspace{15pt}
...
\section{Experience}
	\resumeSubHeadingListStart
		\resumeSubheading{Technology Director}{KJHK 90.7 FM}{Mar 2023 -- Present}
			\resumeItemListStart
				\resumeItem{Led the UI and UX design, architecture, and development of a new mobile application, using React Native and TypeScript, resulting in a user-friendly and cross-platform app that enhanced the station's digital presence with over 8,000 downloads}
...
\section{Projects}
	...
	\resumeSubHeadingListStart
		\resumeProjectHeading{\textbf{KJHK 90.7 FM App}, {TypeScript, React Native, Zetta RCS}}{Nominated for Best App -- IBS 2024}
			...
			\resumeItemListEnd
			\vspace{-15pt}
		\resumeProjectHeading{\textbf{RiceBall}, {TypeScript, SvelteKit, Discord API, Docker, Redis}}{Used in over 4,500 Discord Servers}
			\resumeItemListStart
	...
	\resumeSubHeadingListStart
		...
		\resumeSubheading{Association for Computing Machinery}{Web Manager}{May 2023 -- Dec 2023}
			\resumeItemListStart
				...
				\resumeItem{Started a website overhaul project aimed at enhancing user experience through modernizing the UI and UX design}
			\resumeItemListEnd
	\resumeSubHeadingListEnd
\end{document}